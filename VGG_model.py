...
def load_dataset():
    ...
    for f in uav_files:
        try:
            ...
            X.append(extract_spectrogram_image(y_audio, sr))
            y.append(1)
...
# Build VGG-Style CNN
# =======================
def build_vgg(input_shape=(227, 227, 3)):
...
# Save Model
model.save("uav_binary_vgg_model.h5")
print("✅ Model saved as uav_binary_vgg_model.h5")
